...
def getResult(inputSTR, utterance, args, resultDICT):
    ...
    if utterance == "[32][歲][坂]本[勇人]受[年輕][人]刺激":
        # write your code here
        resultDICT["baseball"] = resultDICT["baseball"]+1
    ...
    if utterance == "[坂]本[勇人]認為[棒次]沒有[太多]影響":
        # write your code here
        resultDICT["baseball"] = resultDICT["baseball"]+1

    if utterance == "[坂]本[勇人]說":
        # write your code here
        resultDICT["baseball"] = resultDICT["baseball"]+1

    if utterance == "[坂]本[勇人]進行[多樣]的[訓練][內容]":
        # write your code here
        resultDICT["baseball"] = resultDICT["baseball"]+1
    ...
    if utterance == "[最後]還[錯]過[球隊]奪下[世界][大賽冠軍]":
        # write your code here
        resultDICT["baseball"] = resultDICT["baseball"]+1
    ...
    if utterance == "接著是[丸][佳浩]和[岡]本和[真]":
        # write your code here
        resultDICT["baseball"] = resultDICT["baseball"]+1
    ...
    if utterance == "結果[他][錯]過了[道奇]拿下[世界][大賽冠軍]的[歷史][時刻]":
        # write your code here
        resultDICT["baseball"] = resultDICT["baseball"]+1
    ...
    if utterance == "讀[賣巨人][隊][32][歲][明星][內][野][手坂]本[勇人]投入[自主]訓練":
        # write your code here
        resultDICT["baseball"] = resultDICT["baseball"]+1
